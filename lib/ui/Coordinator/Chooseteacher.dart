...
class CreateTeacher extends StatefulWidget {
  @override
  CreateTeacherState createState() => new CreateTeacherState();
}

class CreateTeacherState extends State<CreateTeacher> {
                ...
                IconButton(
                    onPressed: () {
                      Navigator.push(
                          context,
                          MaterialPageRoute(
                              builder: (BuildContext context) => ViewTeam()));
                    },
                    icon: Icon(Icons.arrow_back_ios)),
                TextButton(onPressed: () {}, child: Text('Save Group')),
              ],
            ),
          ),
